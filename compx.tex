...
\nouveaumetiersenior{Gourou de secte}
\nouveaumetierpossible{Conseiller en médecine très alternative}
\nouveaumetierpossible{Politique locale}
\nouveaumetierpossible{Rentier}
...
% \ajoutsituation{A}{Élaborer une application informatique}
% \ajoutsituation{A}{Mettre en œuvre une application informatique}
% \ajoutsituation{A}{Maintenir en conditions opérationnelles une application informatique}

% \ajoutsituation{B}{Lancer un nouveau projet}
% \ajoutsituation{B}{Sécuriser des données}
% \ajoutsituation{B}{Exploiter des données pour la prise de décisions}

% \ajoutsituation{C}{Faire évoluer ou concevoir d’une architecture technique}
% \ajoutsituation{C}{Déployer des architectures logicielles communicantes}
% \ajoutsituation{C}{Optimiser et sécuriser des développements et services}
% \ajoutsituation{C}{Qualifier, suivre et résoudre des incidents techniques liés aux plateformes}
% \ajoutsituation{C}{Former et assister les utilisateurs dans une architecture complexe}
