...
% First document created by Jean-Christophe Dubacq
% Name of Jean-Christophe Dubacq doesn't have to be put in the output document, especially
% if compx.tex is rewritten
...
\def\nouveaudomaine#1{\addtocounter{domains}{1}\expandafter\def\csname domaine\Alph{domains}\endcsname{#1}\ifnum\value{domains}=1\xdef\domainsloop{\Alph{domains}}\else\xdef\domainsloop{\domainsloop,\Alph{domains}}\fi}
...
\def\nouveaumetierpossible#1{\addtocounter{metier}{1}\expandafter\def\csname parcours\Alph{parcours}metier\Alph{metier}\endcsname{#1}\expandafter\def\csname parcours\Alph{parcours}metier\Alph{metier}mark\endcsname{$\sim$}}

\def\competenceparcoursniveaux#1#2#3#4{%
  \expandafter\xdef\csname comp#3parcours#4annee#2\endcsname{#1}
  \typeout{Parcours #4 Comp #3 Annee #2 Niveau #1}
}
...
\hypersetup{
  pdftitle={Presentation du referentiel de competences du BUT},
  pdfsubject={Presentation du referentiel de competences du BUT},
  pdfauthor={Jean-Christophe Dubacq},
  pdfkeywords={BUT}
}
\begin{document}
          ...
          \begin{list}{$\bullet$}{\topsep=0pt \partopsep=0pt \parsep=0pt \itemsep=0pt \leftmargin=1em \itemindent=0em}%
            \foreach \YY in \metierloop {%
              ...
              \item[\csname parcours\XX metier\YY mark\endcsname]
                \textcolor{black}{%
                  \csname parcours\XX metier\YY\endcsname%
                }}{}%
            }%
          \end{list}%
        };
