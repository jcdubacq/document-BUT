...
\begin{center}
  ...
  \begin{tabular}{|l|p{100mm}|r|r|r|r|}\hline
    ...
    %% for ll,lname,Lname in [(ls,'SAÉ','SAÉ'),(lr,'ressources','Ressources')]
    %% if ll|length>0
    ...
    \hyperref[FICHE-\VAR{ress.getId()|le}]{\VAR{ress.getId()|le}} & \VAR{ress.getLongtxt()|le} & \VAR{resstot|hoursnum} & \VAR{resstd|hoursnum} & \VAR{resstp|hoursnum} & \VAR{ressproj|hoursnum}  \\\hline
    %% endfor
    ...
    \multicolumn{2}{|>\bfseries l|}{Total des \VAR{lname} du S\VAR{sem|le} parcours \VAR{subparc.getLettreList()|elegantjoin|le}} &\bfseries\VAR{resstot|hoursnum}&\bfseries\VAR{resstd|hoursnum}&\bfseries\VAR{resstp|hoursnum}&\bfseries\VAR{ressproj|hoursnum}\\\hline
    %% endif
    %% endfor
    ...
    \hline
    \multicolumn{2}{|>\bfseries l|}{Total du S\VAR{sem|le} parcours \VAR{subparc.getLettreList()|elegantjoin|le}}&\bfseries\VAR{resstot|hoursnum}&\bfseries\VAR{resstd|hoursnum}&\bfseries\VAR{resstp|hoursnum}&\bfseries\VAR{ressproj|hoursnum}\\\hline
    %% if sem|int is even
    %% set semint=sem|int
    ...
    %% set resstp=data.sumIn(ls+lr,['TP'])-data.sumOut(ls+lr,['TP'])
    %% set ressproj=data.sumIn(ls+lr,['PROJ'])-data.sumOut(ls+lr,['PROJ'])
    \multicolumn{2}{|>\bfseries l|}{Total du S\VAR{othersem|le} parcours \VAR{subparc.getLettreList()|elegantjoin|le} (rappel)}&\bfseries\VAR{resstot|hoursnum}&\bfseries\VAR{resstd|hoursnum}&\bfseries\VAR{resstp|hoursnum}&\bfseries\VAR{ressproj|hoursnum}\\\hline
    ...
    %% set resstp=data.sumIn(ls+lr,['TP'])-data.sumOut(ls+lr,['TP'])
    %% set ressproj=data.sumIn(ls+lr,['PROJ'])-data.sumOut(ls+lr,['PROJ'])
    \multicolumn{2}{|>\bfseries l|}{Total de l'année A\VAR{year|le} parcours \VAR{subparc.getLettreList()|elegantjoin|le}}&\bfseries\VAR{resstot|hoursnum}&\bfseries\VAR{resstd|hoursnum}&\bfseries\VAR{resstp|hoursnum}&\bfseries\VAR{ressproj|hoursnum}\\\hline
