...
\begin{center}
  \begin{tabular}{|l|>{\bfseries}c|\BLOCK{for apc in comp.getAPCObjects(year=year)}p{25mm}|\BLOCK{endfor}}\hline
    Ressource/SAÉ
    &
      \rotatebox[origin=r]{90}{Coefficient}
    &      
    %% for apc in apcs
      \centering\arraybackslash APC \VAR{apc.getNum()|le}\par\raggedright\arraybackslash\fontsize{7pt}{10pt} \VAR{apc.getShorttxt()|le}
      %% if not loop.last
    &
    %% endif
    %% endfor
