...
\newpage
\section{ANNEXE C --- fiche SAÉ \VAR{sae.getId()|le} \emph{\VAR{sae.getShorttxt()|le}}}\label{FICHE-\VAR{sae.getId()|le}}
...
\item Exemple~\VAR{ex.getId()|le} \textbf{[\VAR{ex.getTitre()|le}]}~: \VAR{ex.getSynopsis()|le|join('\n\n')}
  ...
  (formats pédagogique possibles : \VAR{ex.getForm()|elegantjoin|le})
  %% endif
\par
